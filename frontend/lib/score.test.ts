...
function change(
  kind: string,
  category: NonNullable<AttackSurfaceChange['category']>,
): AttackSurfaceChange {
...
describe('scoreDirection', () => {
  ...
  // Go defines Regressed = (scoreDelta > 0) in assessor_models.go.
...
describe('severityForCategory', () => {
  // Mirrors Go's change_taxonomy.go SeverityForCategory.
